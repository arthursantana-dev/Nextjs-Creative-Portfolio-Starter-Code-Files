...
import ScrollBasedImage from '@/components/scrollBasedImage.jsx/ScrollBasedImage';
import { useFrame } from '@react-three/fiber';
import Image from 'next/image'
import { useEffect } from 'react';

export default function cz1000Plus() {
  const images = [
    "/computers/cz_01.png",
    "/computers/cz_02.png",
    "/computers/cz_logo.png",
  ]
  ...
  return (
    <main className="px-4">
      <section className="flex flex-col lg:flex-row relative">
        ...
        <div className="bg-card rounded-2xl sticky top-28 h-[calc(100dvh-8rem)] lg:max-w-[45%] flex-1 flex justify-center items-center overflow-hidden m-0 p-0">
          <ScrollBasedImage images={images}/>
        </div>
      </section>
    </main>
  );
